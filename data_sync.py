...
def sync_data(npy_path, csv_path, txt_path):
    ...
    # 确保按时间排序
    df_csv = df_csv.sort_values('Time_Sec').reset_index(drop=True)
    csv_times = df_csv['Time_Sec'].values
...
if __name__ == "__main__":
    # 请替换为你实际的路径
    npy_path = 'video_recording_realsense#20260205193056.npy' 
    csv_path = 'adc_data_20260205193055.csv'
    txt_path = 'iphone_data_20260205_193047.txt'
